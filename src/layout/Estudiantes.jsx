            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4 flex flex-col'>
                ...
                <div className={`md:block ${menuOpen ? 'block' : 'hidden'} flex flex-col h-full`}>
                    ...
                    <ul className="mt-5 flex-grow">
                        ...
                        <li className="text-center">
                            <Link to='/dashboard/estudiantes' className={`${urlActual === '/dashboard/estudiantes' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Inicio Estudiante</Link>
                        </li>
                        <li className="text-center">
                        ...
                        <li className="text-center">
                            <Link to='/dashboard/estudiantes/actualizar' className={`${urlActual === '/dashboard/estudiantes/actualizar' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Actualizar Estudiante</Link>
                        </li>
                    </ul>
